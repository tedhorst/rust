...
struct ctxt_ {
    ...
    methods: @mut LinearMap<def_id, @method>,

    // Maps from a trait def-id to a list of the def-ids of its methods
    trait_method_def_ids: @mut LinearMap<def_id, @~[def_id]>,

    // A cache for the trait_methods() routine
    trait_methods_cache: @mut LinearMap<def_id, @~[@method]>,
...
pub fn mk_ctxt(s: session::Session,
    ...
    @ctxt_ {
        ...
        methods: @mut LinearMap::new(),
        trait_method_def_ids: @mut LinearMap::new(),
        trait_methods_cache: @mut LinearMap::new(),
...
fn lookup_locally_or_in_crate_store<V:Copy>(
    descr: &str,
    def_id: ast::def_id,
    map: &mut LinearMap<ast::def_id, V>,
